...
const DashboardHeader = ({
  ...
  const confirmLogout = () => {
    Swal.fire({
      ...
      customClass: {
        ...
        // 👇 FIX: Explicitly set visible button styles to prevent display issues

        confirmButton: "text-white bg-blue-600 hover:bg-blue-700", // Ensures visible blue background and white text

        cancelButton: "text-white bg-red-600 hover:bg-red-700", // Ensures visible red background and white text
      },
    }).then((result) => {
  ...
  const currentTitle = (() => {
    ...
    if (p.startsWith("/dashboard/viewdocs")) return "Resources for Parents";
    ...
    <>
      ...
      {isSettingsModalOpen && (
        <AccountSettingsModal
          ...
          onClose={() => setIsSettingsModalModalOpen(false)}
          user={loggedInUser}
